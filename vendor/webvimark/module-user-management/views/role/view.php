                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                <?= GhostHtml::a(UserManagementModule::t('back', 'Edit'),
                                    ['update', 'id' => $role->name], ['class' => 'btn btn-sm btn-primary']) ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <strong>
                                                <span
                                                    class="glyphicon glyphicon-th"></span> <?= UserManagementModule::t('back',
                                                    'Child roles') ?>
                                            </strong>
                                        </div>
                                        <div class="panel-body">
                                                ...
                                                [
                                                    'item' => function ($index, $label, $name, $checked, $value) {
                                                        ...
                                                        $helpIcon = Html::beginTag('span', [
                                                            'title' => UserManagementModule::t('back',
